package com.example.worknutri.ui.agendasFragment.agendaInflater.typesOfRegistryInflater;
...
public class NameRegistryInflater<T> extends RegistryInflater<T> {

    public NameRegistryInflater(Context context) {
        super(context);
    }
