...
public class PatientsClinicRegistryInflater extends RegistryInflater<Clinica> {

    private final List<Paciente> pacientes;
    public PatientsClinicRegistryInflater(Context context, List<Paciente> pacientes) {
        super(context);
