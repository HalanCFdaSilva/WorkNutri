...
import com.example.worknutri.ui.agendasFragment.agendaInflater.RegistryInflater;
...
public class WeekClinicRegistryInflater extends RegistryInflater<Clinica> {
    ...
    public WeekClinicRegistryInflater(Context context, List<DayOfWork> daysOfWork) {
        super(context);
    ...
    private void inflateCategory(ViewGroup viewGroup, List<Clinica> clinicsFiltred) {
        ...
        inflateCard(categoryViewGroup.findViewById(R.id.registry_letter_fragment_linear_layout), clinicsFiltred);
    }
