...
public abstract class AntropometryRegistryInflater extends RegistryInflater<Paciente> {

    protected final List<Antropometria> antropometriaList;

    protected AntropometryRegistryInflater(Context context, List<Antropometria> antropometriaList) {
        super(context);
        this.antropometriaList = antropometriaList;
    }
    protected AntropometryRegistryInflater(Context context) {
