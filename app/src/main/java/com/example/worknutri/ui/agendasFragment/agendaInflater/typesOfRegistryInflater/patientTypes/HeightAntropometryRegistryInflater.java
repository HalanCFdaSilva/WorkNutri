...
public class HeightAntropometryRegistryInflater extends AntropometryRegistryInflater {

    public HeightAntropometryRegistryInflater(Context context, List<Antropometria> antropometrias) {
