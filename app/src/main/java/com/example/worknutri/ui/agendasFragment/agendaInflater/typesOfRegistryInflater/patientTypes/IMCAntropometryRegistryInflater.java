...
public class IMCAntropometryRegistryInflater extends AntropometryRegistryInflater {
    public IMCAntropometryRegistryInflater(Context context, List<Antropometria> antropometriaList) {
