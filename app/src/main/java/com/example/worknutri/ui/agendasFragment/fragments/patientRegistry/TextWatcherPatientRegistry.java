...
public class TextWatcherPatientRegistry implements TextWatcher {
    private final PatientRegistryAdapter adapter;
    private final LinearLayout layoutToInsert;

    public TextWatcherPatientRegistry(PatientRegistryAdapter adapter, LinearLayout layoutToInsert) {
    ...
    public void onTextChanged(CharSequence s, int start, int before, int count) {
        ...
        adapter.inflateAgendaAfterSearch( layoutToInsert, pacientesFiltrados);
