...
import com.example.worknutri.ui.agendasFragment.registryInflater.cardsInflater.PatientCardInflater;
import java.util.ArrayList;
import java.util.List;

public abstract class RegistryInflater<T> {

    protected final Context context;

    protected RegistryInflater(Context context) {
    ...
    public  void generateAgenda(ViewGroup viewGroup, List<T> elementsToAdd){
        ...
        while (!elementsToAddCopy.isEmpty()){
            ...
            inflateCard(categoryViewGroup.findViewById(R.id.registry_letter_fragment_linear_layout), collect);
    ...
    protected ViewGroup generateCategory(T firstElementOfCategory) {
        ViewGroup categoryViewGroup = (ViewGroup) LayoutInflater.from(context).inflate(
                com.example.worknutri.R.layout.registry_letter_fragment, null);

        TextView textView = categoryViewGroup.findViewById(R.id.registry_letter_fragment_agenda_textview);
